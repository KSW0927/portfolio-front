...
const dummyData = [
    { no: "10", eduNo: "1111", deptCategory: "본부전체", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "미수강", totalEduStatus: "50/100 (50%)" },
    { no: "9", eduNo: "1111", deptCategory: "영업본부", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
    { no: "8", eduNo: "1111", deptCategory: "경영지원본부", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
    { no: "7", eduNo: "1111", deptCategory: "해상&해무팀", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
    { no: "6", eduNo: "1111", deptCategory: "선박&공부팀", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
    { no: "5", eduNo: "1111", deptCategory: "안전&안품팀", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
    { no: "4", eduNo: "1111", deptCategory: "총무팀", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
    { no: "3", eduNo: "1111", deptCategory: "총무팀", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
    { no: "2", eduNo: "1111", deptCategory: "총무팀", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
    { no: "1", eduNo: "1111", deptCategory: "총무팀", title: "2022년 국내외 주요 경제 이슈와 전망", instructor: "주원 이사 (현대 경제연구원)", lectureDate: "2022-01-12", status: "수강 완료", totalEduStatus: "50/100 (50%)" },
];
...
export function UI_KSP_8430_L() {
    ...
    const tableColumns: ColDef[] = [
        ...
        { headerName: "부서 분류", field: "deptCategory", minWidth: 200, flex: 0, },
        {
        ...
        { headerName: "전체 교육현황", field: "totalEduStatus", minWidth: 200, flex: 0, },
        {
    ...
    return (
        <>
            <Layout title="부서별 교육(웨비나)" activeMenuId="">
                    ...
                    <SearchBox.Content>
                        <SearchBox.Row>
                            <SearchBox.Item width={isMobile ? "100%" : 140}>
                                <Dropdown label="부서 분류" options={dummyOptions} fullWidth />
                            </SearchBox.Item>
                            ...
                            <SearchBox.Item width={isMobile ? "100%" : 380}>
                                <Input label="검색" placeholder="제목 및 강의자를 검색하세요." leftIcon={<Icon name="search" size={20} />} fullWidth />
                            </SearchBox.Item>
                        </SearchBox.Row>
                    </SearchBox.Content>
