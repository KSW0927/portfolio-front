...
import { Badge, Button, Card, DateRangePicker, Divider, Dropdown, Icon, Input, Layout, SearchBox, Space, Typography } from "@/publishing/components";
...
const dummyData: SurveyItem[] = [
    { id: "1", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
    { id: "2", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
    { id: "3", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
    { id: "4", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
    { id: "5", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
    { id: "6", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120, disabled: true },
    { id: "7", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
    { id: "8", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
    { id: "9", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
    { id: "10", status: "신청중", dday: "D-3", title: "회식장소 투표", startDate: "2026-02-30", endDate: "2026-03-12", current: 20, total: 120 },
];

const TOTAL_PAGES = 3;

export function UI_KSP_8370_L() {
