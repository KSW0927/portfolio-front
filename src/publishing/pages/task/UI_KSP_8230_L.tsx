...
const dummyData: SurveyItem[] = [
    { id: "1", status: "신청중", dday: "D-3", title: "증명서 신청", startDate: "상시 신청" },
    { id: "2", status: "신청중", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
    { id: "3", status: "마감", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
    { id: "4", status: "마감", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
    { id: "5", status: "마감", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
    { id: "6", status: "마감", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
    { id: "7", status: "마감", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
    { id: "8", status: "마감", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
    { id: "9", status: "마감", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
    { id: "10", status: "마감", dday: "D-3", title: "증명서 신청", startDate: "2026-02-30", endDate: "2026-03-12" },
];

const TOTAL_PAGES = 3;

export function UI_KSP_8230_L() {
    const isMobile = useIsMobile();
    const [currentPage, setCurrentPage] = useState(1);

    return (
        <Layout title="업무별 신청" activeMenuId="">
                ...
                <SearchBox.Content>
                    <SearchBox.Row>
                        ...
                        <SearchBox.Item width={isMobile ? "100%" : 357}>
                            <DateRangePicker label="신청 시작일" startDate={null} endDate={null} onChange={() => { }} />
                        </SearchBox.Item>
                            ...
                            <Card variant="light" size="xl" layout={isMobile ? "vertical" : "horizontal"} className="list-grid-item">
                                <Card.Body className="list-grid-contents">
                                    ...
                                    <div className="list-grid-item-meta">
                                        <Space size={4}>
                                            ...
                                            <Typography variant="body-md" secondary>{item.startDate} {item.endDate ? `~ ${item.endDate}` : ""}</Typography>
                                        </Space>
                                    </div>
                                </Card.Body>
                                ...
                                <Card.Actions>
                                    ...
                                    <Button
                                        variant="filled"
                                        disabled={item.disabled}
                                        leftIcon={<Icon name="chart" size={18} color={item.disabled ? "#999" : "#005AAA"} />}
                                    >
                                        현황보기
                                    </Button>
                                </Card.Actions>
