...
import { Box, Button, DataGrid, type DataGridHandle, Dropdown, Icon, Input, Layout, Table, Textarea } from "@/publishing/components";
...
export function UI_KSP_8221_R() {
    ...
    return (
        <Layout title="비정형 데이터 등록/수정" favorite={false} activeMenuId="">
