...
export const Box = ({
    ...
    return (
        <div className={classes} style={{ gap, backgroundColor: bgColor, border: borderColor ? `1px solid ${borderColor}` : undefined, padding, paddingTop, paddingRight, paddingBottom, paddingLeft }} {...props}>
            {header && (
