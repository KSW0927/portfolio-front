...
import { UncontrolledTreeEnvironment, Tree, StaticTreeDataProvider, type TreeItem, type TreeItemIndex, InteractionMode } from "react-complex-tree";
import { Box, Button, Icon, Layout, Typography } from "@/components";
...
const TreeListSidebar = ({ mobileButtonText, title, pcWidth = 256, children }: TreeListSidebarProps) => {
    ...
    if (isMobile) {
        return (
            <>
                <Button fullWidth onClick={() => setIsOpen(true)}>{mobileButtonText}</Button>
